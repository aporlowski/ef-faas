...
## References
[1] "Using GAS for Speedy Generation of Hybrid Multi-Cloud AutoGenerated AI Services." GREGOR VON LASZEWSKI, ANTHONY ORLOWSKI, RICHARD OTTEN, REILLY MARKOWITZ,SUNNY GANDHI, ADAM CHAI, CALEB WILSON, GEOFFREY C. FOX, and WO L. CHANG.<https://raw.githubusercontent.com/laszewski/laszewski.github.io/master/papers/vonLaszewski-openapi.pdf>

[pricing] "Pricing | Cloud Functions Documentation | Google Cloud." Google Cloud, 23 Nov. 2020, <https://cloud.google.com/functions/pricing>.

[local-dev] "Local Development | Cloud Functions Documentation | Google Cloud." Google Cloud, 1 Dec. 2020, <https://cloud.google.com/functions/docs/running/overview>.
